...
double *xs2, size_t xsLength2, double *ys2, size_t ysLength2, wchar_t name[]){
  ScatterPlotSettings *settings;
  ...
  settings->autoBoundaries = true;
  settings->xMax = (double)xsLength;
  settings->autoPadding = true;
  settings->title = name;
  settings->titleLength = wcslen(settings->title);
  settings->xLabel = L"Output";
  settings->xLabelLength = wcslen(settings->xLabel);
  ...
  settings->scatterPlotSeries[0]->lineType = L"dashed";
  settings->scatterPlotSeries[0]->lineTypeLength = wcslen(settings->scatterPlotSeries[0]->lineType);
  settings->scatterPlotSeries[0]->lineThickness = 1;

  settings->scatterPlotSeries[1] = GetDefaultScatterPlotSeriesSettings();
  free(settings->scatterPlotSeries[1]->xs);
  settings->scatterPlotSeries[1]->xs = xs2;
  settings->scatterPlotSeries[1]->xsLength = xsLength2;
  free(settings->scatterPlotSeries[1]->ys);
  settings->scatterPlotSeries[1]->ys = ys2;
  settings->scatterPlotSeries[1]->ysLength = ysLength2;
  ...
  settings->scatterPlotSeries[1]->lineThickness = 1;
...
double test(){
  ...
  xs2 = (double*)malloc(sizeof(double) * (5.0));
  xsLength2 = 5.0;
  xs2[0] =  -2.0;
  xs2[1] =  -1.0;
  xs2[2] = 0.0;
  xs2[3] = 1.0;
  xs2[4] = 2.0;
  ys2 = (double*)malloc(sizeof(double) * (5.0));
  ysLength2 = 5.0;
  ys2[0] = 2.0;
  ys2[1] =  -1.0;
  ys2[2] =  -2.0;
  ys2[3] =  -1.0;
  ys2[4] = 2.0;
  // DrawScatterPlot(imageReference, 800.0, 600.0, xs, xsLength, ys, ysLength, xs2, xsLength2, ys2, ysLength2);
